...
1. **Fase 2.2 - Cadastro e edição de igreja**
2. Fase 2.3 - Cadastro e edição de organista
3. Fase 2.4 - Geração de escala
4. Fase 2.5 - Edição manual e exportação
5. Fase 3 - Integrar, documentar e estabilizar no CI
